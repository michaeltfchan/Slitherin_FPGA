...
HD_PWD='C:/Users/budiwarm/snake_game_axi4_full_folder/snake_game_axi4_full/snake_game_axi4_full.runs/snake_game_slave_axi_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_game_slave_axi_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_game_slave_axi_0.tcl
