...
HD_PWD='C:/Users/budiwarm/snake_game_axi4_full_folder/snake_game_slave_axi_folder/snake_game_slave_axi/snake_game_slave_axi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_game_slave_axi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_game_slave_axi.tcl
