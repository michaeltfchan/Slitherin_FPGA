...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_all is
  ...
  attribute SOFT_HLUTNM of \G_PROBE_OUT[2].wr_probe_out[2]_i_2\ : label is "soft_lutpair22";
begin
...
\Probe_out_reg_int[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => D(1),
      I3 => D(0),
      I4 => \G_PROBE_OUT[1].PROBE_OUT0_INST_n_3\,
...
DECODER_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder
     port map (
      ...
      Q(1) => PROBE_OUT_ALL_INST_n_8,
      Q(0) => PROBE_OUT_ALL_INST_n_9,
      SR(0) => clear,
      addr_count => addr_count,
      in0 => committ,
      \out\ => bus_clk,
...
PROBE_OUT_ALL_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_all
     port map (
      ...
      \G_PROBE_OUT[2].wr_probe_out[2]_i_3_0\ => PROBE_OUT_ALL_INST_n_5,
      \G_PROBE_OUT[2].wr_probe_out[2]_i_4_0\ => PROBE_OUT_ALL_INST_n_6,
      \Probe_out_reg_int_reg[1]_0\(1) => PROBE_OUT_ALL_INST_n_8,
      \Probe_out_reg_int_reg[1]_0\(0) => PROBE_OUT_ALL_INST_n_9,
      Q(1) => p_0_in,
      Q(0) => p_2_in,
      SR(0) => clear,
      clk => clk,
