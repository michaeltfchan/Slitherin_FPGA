...
HD_PWD='C:/Users/chanmi53/snake_top/snake_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_game_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_game_top.tcl
