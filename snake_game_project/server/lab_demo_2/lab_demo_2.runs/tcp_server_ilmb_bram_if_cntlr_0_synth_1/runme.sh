...
HD_PWD='C:/Users/zhan4820/game_server_mar_22/lab_demo_2/lab_demo_2.runs/tcp_server_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tcp_server_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tcp_server_ilmb_bram_if_cntlr_0.tcl
