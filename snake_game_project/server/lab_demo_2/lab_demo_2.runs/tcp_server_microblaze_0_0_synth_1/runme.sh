...
HD_PWD='C:/Users/budiwarm/lab_demo_2/lab_demo_2.runs/tcp_server_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tcp_server_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tcp_server_microblaze_0_0.tcl
