...
HD_PWD='C:/Users/zhan4820/game_server_mar_22/lab_demo_2/lab_demo_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tcp_server_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tcp_server_wrapper.tcl
